...
class _ReportEmployeeState extends State<ReportEmployee> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (BuildContext context) => AppCubit()..getallReports(),
                    ...
                    ConditionalBuilder(
                      ...
                      builder: (context) => Expanded(
                        child: ListView.builder(
                            itemCount:
                                AppCubit.get(context).allReports.reports.length,
                            itemBuilder: (context, pos) {
                              return item(
                                  AppCubit.get(context).allReports.reports[pos],
                                  () {
                                AppCubit.get(context).acceptReport(pos, pos);
                              }, () {
                                AppCubit.get(context).cancelReport(pos, pos);
                              }, context);
                            }),
                      ),
                      fallback: (context) =>
