...
import 'package:project/view/layout_screens/payroll%20_sheet_1.dart';
...
class Payroll_Screen extends StatelessWidget {
                    ...
                    Expanded(
                      ...
                      child: ListView.builder(
                          ...
                          itemBuilder: (context, pos) {
                            return itemList(context: context,function: (){
  ...
  Widget itemList({required BuildContext context,required Function function}) {
    return Padding(
