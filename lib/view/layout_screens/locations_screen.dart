...
class Locations_Screen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: mycustomAppbar(
          ...
          search: true,
          toolbarHeight: 140),
      body: ListView.builder(itemCount: 30, itemBuilder: (context, pos) {
        ...
        return Card(elevation: 8, child: Container(height: MediaQuery
            .of(context)
            .size
            .height * .3, child: Column(crossAxisAlignment: CrossAxisAlignment.end,
children: [
  Expanded(
    child: GoogleMap(
