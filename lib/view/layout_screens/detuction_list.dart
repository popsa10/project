...
// Group: Group 69934
  ...
  Widget itemList({required Size size,required BuildContext context, required Function function}) {
    return Padding(
      ...
      child: Container(
        ...
        child: Row( mainAxisSize: MainAxisSize.max,mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            Column(
